...
export class DespesaService {
  ...
  public inserir(
    ...
    const resposta = this.http
      .post<FormsDespesaViewModel>(
        this.apiUrl + 'despesas',
        despesa,
  ...
  public editar(
    ...
    const resposta = this.http
      .put<FormsDespesaViewModel>(
        this.apiUrl + 'despesas/' + despesa.id,
        despesa,
        this.obterHeadersAutorizacao()
      )
      .pipe(map(this.processarDados), catchError(this.processarFalha));
  ...
  public visualizarDespesaCompletaPorId(
    id: string
  ): Observable<VisualizarDespesaViewModel> {
    const resposta = this.http
      .get<VisualizarDespesaViewModel>(
        this.apiUrl + 'despesas/visualizacao-completa/' + id,
        this.obterHeadersAutorizacao()
      )
      .pipe(map(this.processarDados), catchError(this.processarFalha));
